...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAutoComp; // this vault is purely for staking. eg. WBNB-lime staking vault.
    ...
    address public limeExchangeRouterAddress;
    
    address public constant wbnbAddress =
        0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address public LimeFarmAddress;
    address public limeAddress;
    ...
    address[] public earnedTolimePath;
    ...
    constructor(
        address _LimeFarmAddress,
        address _limeAddress,
        bool _isCAKEStaking,
        bool _isAutoComp,
        ...
        LimeFarmAddress = _LimeFarmAddress;
        limeAddress = _limeAddress;
        ...
        if (isAutoComp) {
            ...
            limeExchangeRouterAddress = _uniRouterAddress;
    
            earnedTolimePath = [earnedAddress, limeAddress];
            if (wbnbAddress == earnedAddress) {
                earnedTolimePath = [wbnbAddress, limeAddress];
            }
        ...
        transferOwnership(LimeFarmAddress);
    }
    ...
    function _farm() internal {
        ...
        // For HyperJump Fee
        uint256 lpFee = wantAmt.div(100);
        wantLockedTotal = wantLockedTotal.add(wantAmt.sub(lpFee));
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(LimeFarmAddress, _wantAmt);
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        IERC20(earnedAddress).safeIncreaseAllowance(
            limeExchangeRouterAddress,
            buyBackAmt
        );
    
        IPancakeRouter02(limeExchangeRouterAddress)
            .swapExactTokensForTokensSupportingFeeOnTransferTokens(
            buyBackAmt,
            0,
            earnedTolimePath,
    ...
    function setPaths(
        ...
        address _limeExchangeRouterAddress
    ) public {
          earnedTolimePath = _earnedTolimePath;
          earnedToToken0Path = _earnedToToken0Path;
          earnedToToken1Path = _earnedToToken1Path;
          token0ToEarnedPath = _token0ToEarnedPath;
          token1ToEarnedPath = _token1ToEarnedPath;
          limeExchangeRouterAddress = _limeExchangeRouterAddress;
    }
}
